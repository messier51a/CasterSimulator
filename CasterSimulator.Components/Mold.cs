...
namespace CasterSimulator.Components
{
    ...
    public class Mold : SteelContainer
    {
        ...
        /// <param name="maxLevel">Maximum steel level inside the mold in millimeters.</param>
        ...
        public Mold(string id, double width, double depth, double maxLevel)
            : base(new ContainerDetails(id, false)
            {
                Width = width,
                Depth = depth,
                MaxLevel = maxLevel,
                ThresholdWeight = maxLevel * width * depth * 7850, // Steel density assumption
                InitialFlowRate = 0
            })
        {
        }
